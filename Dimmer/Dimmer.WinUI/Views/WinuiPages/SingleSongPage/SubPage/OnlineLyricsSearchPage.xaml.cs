...
/// </summary>
public sealed partial class OnlineLyricsSearchPage : Page
{
    public OnlineLyricsSearchPage()
    {
        InitializeComponent();
    }
    ...
    {
        LrcLibLyrics? lyricData = (LrcLibLyrics)((Button)sender).CommandParameter;
    ...
    public async void SearchLyricsBtn_Click(object sender, RoutedEventArgs e)
    {

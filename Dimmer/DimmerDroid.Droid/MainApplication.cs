...
namespace DimmerDroid.Droid
{
    ...
    public class MainApplication : MauiApplication
    {
        ...
        private static void OnUnhandledException(object sender, UnhandledExceptionEventArgs e)
        {
            ...
            {
                Console.WriteLine(
                    $"Cannot log to IErrorHandler: ServiceProvider is null." +
        ...
        /// <summary>
        /// Logs memory-related events to the crash log file. Thread-safe: uses the same lock as LogException to prevent
        ...
        /// <summary>
        /// Performs aggressive garbage collection to free up memory. This pattern (GC twice with
        /// WaitForPendingFinalizers in between) is necessary in memory-critical situations to ensure objects with
        /// finalizers are properly collected: 1. First GC.Collect() - collects regular objects and queues finalizers 2.
        /// WaitForPendingFinalizers() - runs finalizers, which may free more references 3. Second GC.Collect() -
        /// collects objects that became eligible after finalizers ran
        /// </summary>
        ...
        /// <summary>
        /// Called when the system is running low on memory, and actively running processes should trim their memory
        /// usage.
        /// </summary>
        ...
        /// <summary>
        /// Called when the overall system is running low on memory. Legacy callback for older Android versions.
        /// </summary>

    ...
    protected override void SetupAnimation(ShellNavigationSource navSource, FragmentTransaction t, Page page)
    {
        ...
        switch (navSource)
        {
            case ShellNavigationSource.Push:
                ...
                //if (page is HomePage)
                //{
                    enterAnim = (int)_animationService.GetHomePagePushEnterAnimation().ResourceId;
                    exitAnim = (int)_animationService.GetHomePagePushExitAnimation().ResourceId;
                    popEnterAnim = (int)_animationService.GetHomePagePopEnterAnimation().ResourceId;
                    popExitAnim = (int)_animationService.GetDefaultPopExitAnimation().ResourceId;
                //}
                //else
                //{

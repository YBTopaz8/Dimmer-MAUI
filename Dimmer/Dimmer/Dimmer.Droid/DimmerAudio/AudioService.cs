...
public partial class AudioService : IDimmerAudioService, INotifyPropertyChanged, IAsyncDisposable, IAudioActivity
{
    ...
    public event EventHandler<PlaybackEventArgs>? PlayPrevious; // Can be triggered manually or via service events if implemented
    public event EventHandler<PlaybackEventArgs>? PlayNext;     // Can be triggered manually or via service events if implemented

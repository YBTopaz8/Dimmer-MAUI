...
{
    // 1. Play count
    public static int GetPlayCount(SongModel song, List<DimmerPlayEvent> events)
    {
        return events.Count(e => e.SongId == song.Id && e.PlayType == 0);
    }

    // 2. Skip count
    public static int GetSkipCount(SongModel song, List<DimmerPlayEvent> events)
    {
        return events.Count(e => e.SongId == song.Id && e.PlayType == 5);
    }

    // 3. Complete play count
    public static int GetCompletedPlayCount(SongModel song, List<DimmerPlayEvent> events)
    {
        return events.Count(e => e.SongId == song.Id && e.PlayType==3);
    }

    // 4. Average percent listened (as a fraction)
    public static double GetAvgPercentListened(SongModel song, List<DimmerPlayEvent> events)
    {
    ...
    // 5. Last played date
    public static DateTimeOffset? GetLastPlayedDate(SongModel song, List<DimmerPlayEvent> events)
    {
    ...
    // 6. First played date
    public static DateTimeOffset? GetFirstPlayedDate(SongModel song, List<DimmerPlayEvent> events)
    {
        return events.Where(e => e.SongId == song.Id && e.PlayType == 0)
    ...
    public static List<string> GetPlayedDevices(SongModel song, List<DimmerPlayEvent> events)
    {
    ...
    // 8. Most used device
    public static string? GetMostUsedDevice(SongModel song, List<DimmerPlayEvent> events)
    {
        return events.Where(e => e.SongId == song.Id && !string.IsNullOrEmpty(e.DeviceName))
    ...
    public static int? GetMostActiveHour(SongModel song, List<DimmerPlayEvent> events)
    {
        return events.Where(e => e.SongId == song.Id)
    ...
    public static bool WasEverCompleted(SongModel song, List<DimmerPlayEvent> events)
    {
        return events.Any(e => e.SongId == song.Id && e.PlayType == 3);
    }

    // 13. Number of times resumed
    public static int GetResumeCount(SongModel song, List<DimmerPlayEvent> events)
    {
        return events.Count(e => e.SongId == song.Id && e.PlayType == 2);
    }

    // 14. Distinct days song was played
    public static int GetDistinctDaysPlayed(SongModel song, List<DimmerPlayEvent> events)
    {
        return events.Where(e => e.SongId == song.Id)
    ...
    public static double GetAvgPositionWhenSkipped(SongModel song, List<DimmerPlayEvent> events)
    {
    ...
    public static string? GetMostRecentDevice(SongModel song, List<DimmerPlayEvent> events)
    {
        return events.Where(e => e.SongId == song.Id && !string.IsNullOrEmpty(e.DeviceName))
                     .OrderByDescending(e => e.DatePlayed)
    ...
    public static int GetPlayCountAsFavorite(SongModel song, List<DimmerPlayEvent> events)
    {
        return song.IsFavorite ? GetPlayCount(song, events) : 0;
    }

    // 21. Number of skips after 50% played
    public static int GetSkipAfterHalfPlayedCount(SongModel song, List<DimmerPlayEvent> events)
    {
    ...
    public static int GetLyricViewSessions(SongModel song, List<DimmerPlayEvent> events)
    {
        return events.Count(e => e.SongId == song.Id && e.PlayType == 10); // suppose 10 = LyricView
    }

    // 23. Days since last play
    public static int? GetDaysSinceLastPlay(SongModel song, List<DimmerPlayEvent> events)
    {
    ...
    public static int GetUniqueDevicesCount(SongModel song, List<DimmerPlayEvent> events)
    {
        return GetPlayedDevices(song, events).Count;
    }

    // 25. Was the song ever played at midnight?
    public static bool WasPlayedAtMidnight(SongModel song, List<DimmerPlayEvent> events)
    {
...
public static class SongComparison
{
    ...
    public static SongModel GetMorePlayedSong(SongModel songA, SongModel songB, List<DimmerPlayEvent> events)
    {
    ...
    public static SongModel GetMostRecentlyPlayedSong(SongModel songA, SongModel songB, List<DimmerPlayEvent> events)
    {
    ...
    public static SongModel GetMoreSkippedSong(SongModel songA, SongModel songB, List<DimmerPlayEvent> events)
    {
    ...
    public static SongModel GetSongWithMoreDevices(SongModel songA, SongModel songB, List<DimmerPlayEvent> events)
    {
    ...
    public static double GetListeningTimeDifference(SongModel songA, SongModel songB, List<DimmerPlayEvent> events)
    {
    ...
    public static List<string> GetCommonDevices(SongModel songA, SongModel songB, List<DimmerPlayEvent> events)
    {
    ...
    public static bool WerePlayedBackToBack(SongModel songA, SongModel songB, List<DimmerPlayEvent> events)
    {
    ...
    public static SongModel GetMoreSkippedBeforeHalf(SongModel songA, SongModel songB, List<DimmerPlayEvent> events)
    {
    ...
    public static bool WerePlayedSameDay(SongModel songA, SongModel songB, List<DimmerPlayEvent> events)
    {
    ...
    public static SongModel GetSongWithLongerAvgSession(SongModel songA, SongModel songB, List<DimmerPlayEvent> events)
    {
    ...
    public static SongModel GetSongWithMoreDistinctDaysPlayed(SongModel songA, SongModel songB, List<DimmerPlayEvent> events)
    {
    ...
    public static SongModel GetSongWithHigherAvgPercentListened(SongModel songA, SongModel songB, List<DimmerPlayEvent> events)
    {
    ...
    public static SongModel GetSongWithMoreDeviceModels(SongModel songA, SongModel songB, List<DimmerPlayEvent> events)
    {
    ...
    public static bool WereBothCompletedSameSession(SongModel songA, SongModel songB, List<DimmerPlayEvent> events)
    {
    ...
    public static int? DaysBetweenFirstPlays(SongModel songA, SongModel songB, List<DimmerPlayEvent> events)
    {
    ...
    public static bool IsAlwaysPlayedAfter(SongModel songA, SongModel songB, List<DimmerPlayEvent> events)
    {
    ...
    public static SongModel GetSongSkippedMoreAfter80Percent(SongModel songA, SongModel songB, List<DimmerPlayEvent> events)
    {
    ...
    public static SongModel GetMoreNightPlays(SongModel songA, SongModel songB, List<DimmerPlayEvent> events)
    {
    ...
    public static SongModel GetSongWithMoreSkipsPerDay(SongModel songA, SongModel songB, List<DimmerPlayEvent> events)
    {
    ...
    public static bool HaveCommonManufacturer(SongModel songA, SongModel songB, List<DimmerPlayEvent> events)
    {
    ...
    public static SongModel GetSongWithMoreRecentDifferentDevice(SongModel songA, SongModel songB, List<DimmerPlayEvent> events)
    {

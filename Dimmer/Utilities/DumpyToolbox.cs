...
class DumpyToolbox
{
    ...
    //    {
    //        DimmerAudioService.Current.ApplyEqualizerPreset(presetEnum);
    //    }
    //    else
    //    {
    //        Debug.WriteLine($"Invalid preset name selected: {selectedPresetName}");
    //        // Handle invalid preset name (optional)
    //    }
    //}
}
